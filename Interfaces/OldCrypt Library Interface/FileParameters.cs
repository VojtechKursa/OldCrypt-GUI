...
namespace OldCrypt_GUI.Interfaces.OldCrypt_Library_Interface
{
    ...
    public class FileParameters
    {
        ...
        /// </summary>
        /// <param name="cipher"><see cref="OldCrypt_Library.Cipher"/> to use in the <see cref="OldCrypt_Interface.EncryptFile(object)"/> or <see cref="OldCrypt_Interface.DecryptFile(object)"/> methods.</param>
