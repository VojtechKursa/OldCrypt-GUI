...
namespace OldCrypt.GUI.Interfaces.OldCrypt.Library_Interface
{
	public static class OldCrypt_Interface
	{
		...
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.Encrypt(string)"/></exception>
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.Encrypt(byte[])"/></exception>
		...
		/// <exception cref="ArgumentException"/>
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.Decrypt(string)"/></exception>
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.Decrypt(byte[])"/></exception>
		...
		/// <exception cref="ArgumentException"/>
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.EncryptFile(System.IO.BinaryReader, System.IO.BinaryWriter)"/></exception>
		...
		/// <exception cref="ArgumentException"/>
		/// <exception><inheritdoc cref="OldCrypt.Library.Cipher.DecryptFile(System.IO.BinaryReader, System.IO.BinaryWriter)"/></exception>
