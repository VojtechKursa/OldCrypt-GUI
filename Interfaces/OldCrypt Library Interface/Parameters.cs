...
namespace OldCrypt.GUI.Interfaces.OldCrypt.Library_Interface
{
	...
	public class Parameters<Type>
	{
		...
		/// </summary>
		/// <param name="cipher"><see cref="OldCrypt.Library.Cipher"/> to use in the <see cref="OldCrypt_Interface.Encrypt(object)"/> or <see cref="OldCrypt_Interface.Decrypt(object)"/> methods.</param>
